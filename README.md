...
- 🏅 1학기 성적우수상 (2등)
- 🏅 2학기 공통PJT (Scentify : 사용자 맞춤 스마트 디퓨져) (2등)

---

## 💼 Experience

### 👨‍🏫 프로그래머스 데브코스 백엔드 교육과정 | FT (보조강사)
`2025.03 – 2025.08`
- 수강생 코드 리뷰 및 기술 질의응답 지원
- 학습 보조 및 팀 프로젝트 멘토링

### 👨‍🏫 범농협 생성형 AI 활용 교육 | 보조강사
`2025.11`
- 수강생 오프라인 실습 지원 및 질의응답

### 👩‍💻 교원구몬 구몬통합시스템프로젝트팀 | IT 프로젝트 기획 매니저
`2026.02 – Present`
- 통합 시스템 프로젝트 기획 및 운영
